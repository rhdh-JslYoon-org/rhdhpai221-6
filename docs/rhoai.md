...
2) Go to the `Data Science Projects` section and access your application's project named `rhdhpai221-6`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `rhdhpai221-6-notebook`.
...
5) In the terminal, run `cd rhdhpai221-6` to navigate to your sample app's directory.
